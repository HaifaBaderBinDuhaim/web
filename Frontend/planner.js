...
const timeSlots = [
    ...
    "01:00 PM", "02:00 PM", "03:00 PM", "04:00 PM", "05:00 PM", "06:00 PM", "07:00 PM", "08:00 PM", "09:00 PM", "10:00 PM", "11:00 PM", "12:00 AM", "01:00 AM", "02:00 AM", "03:00 AM", "04:00 AM", "05:00 AM", "06:00 AM", "07:00 AM"  
];

// مصفوفة الجلسات المرفقة
let sessions = JSON.parse(localStorage.getItem('plannerSessions')) || [];
...
window.onclick = function(event) { if (event == modal) { modal.style.display = 'none'; } }
...
sessionForm.onsubmit = function(e) {
    ...
    if (id) {
        sessions = sessions.map(s => s.id === id ? sessionData : s);
    } else {
    ...
    return s.day === day && sessionHour === slot24;
            ...
            if (matchedSession) {
                ...
                sessionCard.onclick = function() {
                    openEditModal(matchedSession.id);
                };
