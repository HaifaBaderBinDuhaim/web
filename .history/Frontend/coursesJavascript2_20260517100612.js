...
// we don't need this function anymore because we are saving the courses directly to the database and fetching them from there, but we will keep it here in case we want to use it later for some reason
